...
<nested:form action="/futureDatedTxnsReport">
<div id="printReady">
<%
		 ...
		 <table class="inner-table table-border" cellSpacing="1" cellPadding="2" width="100%" border="0">
            ...
            <tr class="row-value">
              ...
              <nested:define id = "toDate" property="reportDto.toDate" type="java.lang.String"/>
                  ...
                  <nested:define id ="status" property="reportDto.status" type="java.lang.String"/>
                    RTGS Date wise Future Dated Txns Report for 
                    ...
                    <br>with status <%if(status.equalsIgnoreCase("2000")) {%>
                    Active
                    <% } else {%>
                    Cancelled
                    <% }%>
              ...
              <td  colspan="11" align="center">
                <TABLE>
                    ...
                    <%
                        date = _date;
                    %>
						<td colspan=11 align="left"><b> Date : <%=date%> </b> </td>
               		</tr>
                    <tr class="row-label th-bc">
                        ...
                        <%}%>
                         <td width="10%" align="center">Entry By</td>
                        <td width="10%" align="center">Cancelled By</td>
                    ...
                    %>
                			...
                			<% } %>
                                ...
                                <% if(subType.equalsIgnoreCase("R41")) {%>
                                 <td align="left" nowrap>&nbsp;<%=_repDto.getFieldA5561()%></td>
                                 <td align="left" wrap>&nbsp;<%=_repDto.getFieldN5561()%></td>
                                 <% } else {%>
                                 <td align="left" nowrap>&nbsp;<%=_repDto.getFieldI7495()%></td>
                                 <td align="left" wrap>&nbsp;<%=_repDto.getFieldA7495()%></td>
                                 <% }%>
                                <td align="center" nowrap>&nbsp;<%=_repDto.getEntryBy()%></td>
                                <td align="center" nowrap>&nbsp;<%=_repDto.getPassBy()%></td>
                                 <%
                   ...
                   %>
                    <td colspan=8 align="right"><b>	Total (Date : <%=date%> )&nbsp;&nbsp;</b></td>
            ...
            <tr class="row-value tr2-bc">
                <td colspan="11" align="right"><b>	Total Amount : &nbsp; <%=FormatAmount.formatINRAmount(dateWiseAmt)%></b></td>
            </tr>
          </nested:notEmpty>
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/reportInput.do?module=reports&mode=input&report=futureDatedTxns';
