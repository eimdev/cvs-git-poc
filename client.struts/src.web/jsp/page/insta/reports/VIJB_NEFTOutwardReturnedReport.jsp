...
<nested:form action="/neftOwReturnedReport">
<div id="printReady">
<%
	    ...
	    <td>
		 <table class="inner-table table-border" cellSpacing="1" cellPadding="2" width="100%" border="0">
            ...
            <tr class="row-label th-bc">
                ...
                <td width="15%" align="center" >Original UTR Number</td>
            ...
            <nested:iterate indexId = "index" id ="reportDto" property="reportDTOs"> 
              <% k = k ? false : true;
                ...
                <td align="left">
                	<nested:write property = "batchTime"/>
                </td>
...
<!--
    function printScript() {
        ...
        var title = new String("Outward Returned Reports.");
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/neftReportInput.do?module=reports&mode=input&report=OwReturnedReport';
