...
<nested:form action="/neftUtrNoWiseReport">
<div id="printReady">
<%
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <font size="2.5">
            ...
            Report on UTR Number : <%=utrNo.toUpperCase() %> for NEFT
        </font>
        </b>
        </td>
    </tr>
	...
	<nested:define id="senderAddress5756" property="messageDTO.senderAddress" type="java.lang.String"/>
	<nested:define id="receiverAddress5569" property="messageDTO.receiverAddress" type="java.lang.String"/>
    <tr>
	    <td>
		   				...
		   				<tr>
         						<td align="center" class="row-value" nowrap="nowrap">
                            		<nested:notEmpty property="msgFieldValue">
	         							...
	         							<%if((fieldNumber.equals("5756"))||(fieldNumber.equals("5569"))) { %> <!-- Checking for sender or receiver address -->
	         						
	         								<%if(fieldNumber.equals("5756")){%>
	         								<%=senderAddress5756%>
	         							<%} else if(fieldNumber.equals("5569")){%>
	         								<%=receiverAddress5569%>
	         							<%}%>
	         							 <%} else {%>	
					...
					<% if (isDisplay_compound_1.booleanValue()) { %>
						...
						<%	} else {%><tr height="22" class="row-value tr2-bc">
				   		<%	} %>
				   			...
				   			<nested:define id="fieldNumber" property="msgFieldNumber" type="java.lang.String"/> 
				   			<% if(fieldNumber.equalsIgnoreCase("3380")) { %>
				   			...
				   			<% } else if(fieldNumber.equalsIgnoreCase("4038")) { %>
