...
<nested:form action="/r42outwardreport">
<div id="printReady">
<%
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr class="row-value">
        ...
        <nested:define id = "valueDate" property="reportDto.valueDate" type="java.lang.String"/>
            <b>
            	<font size="2.0">
                	Interbank Payments Submitted - Grouped By Receiver Address on <br><%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%>
                </font>
            </b>
    	</td>
    </tr>
				   ...
				   <nested:iterate property="reportDTOs">
        			...
        			<% } %>
						<td align="center" width="30"><%=i%></td>
                       	<td align="left" >&nbsp;<nested:write property="receiverAddress"/></td>
