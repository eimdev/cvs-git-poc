...
<nested:form action="/tranDetailsReport">
<div id="printReady">
<%
		 ...
		 <table class="inner-table table-border" cellSpacing="1" cellPadding="2" width="100%" border="0">
            ...
            <tr class="row-value">
              ...
              <nested:define id = "toDate" property="reportDto.toDate" type="java.lang.String"/>
                  <b>
                  <font size="2.5">
                  	<nested:define id="_payment" property="reportDto.paymentType" type="java.lang.String"/>
                  	Individual Transaction Detailed Report for
                  	<% if(_payment.equalsIgnoreCase("All")) { %>
                  		All Payments
                  	<% } else if(_payment.equalsIgnoreCase("R41")) { %>
                  		Customer Payment
                  	<% } else if(_payment.equalsIgnoreCase("R42")) { %>
                  		Interbank Payment
                  	<% } else if(_payment.equalsIgnoreCase("R10")) { %>
                  		OATR Payment
                  	<% } else if(_payment.equalsIgnoreCase("R44")) { %>
                  		Credit Notification
                  	<% } else if(_payment.equalsIgnoreCase("R43")) { %>
                  		Debit Notification
                  	<% } %> 
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/reportInput.do?module=reports&mode=input&report=TransactionDetailsReport';
