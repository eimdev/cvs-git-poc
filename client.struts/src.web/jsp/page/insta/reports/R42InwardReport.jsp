...
<nested:form action="/r42inwardreport">
<div id="printReady">
<%
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr class="row-value">
        ...
        <nested:define id = "valueDate" property="reportDto.valueDate" type="java.lang.String"/>
            <b>
            	<font size="2.0">
                	Interbank Payments Received - Grouped By Sender Address on <br><%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%>
                </font>
            </b>
    	</td>
    </tr>
