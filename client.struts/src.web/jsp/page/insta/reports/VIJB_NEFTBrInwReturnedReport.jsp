...
<nested:form action="/neftBrInwReturnedReport">
<div id="printReady">
<%
    String imagePath = imageBase + "/print.jpg";
%>
<nested:define id="batchTime" property="reportDto.batchTime" type = "java.lang.String"/>
            ...
            <tr  class="row-value">
              <td colspan="8" align="center" class="row-value">
        		 ...
        		 <nested:define id = "valueDate" property="reportDto.valueDate" type="java.lang.String"/>
                  ...
                  <b>
                  <font size="2.0">
                    Branchwise Inward Returned Report - from <%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%> to <%=InstaReportUtil.getDateInSpecificFormat(format,toDate)%>
                    </font>
                  </b>
              </td>
              </tr>
              ...
              <td  colspan="8" align="center">
                <TABLE>
                    ...
                    <%
                        txnDate = _date;
                    %>
                    <!-- Here batch time remove by priyak for user requirement -->
               		</tr>
                    <tr class="row-label th-bc">
                        <td width="5%" align="center">S.NO</td>
                        <td width="5%" align="center">BATCH TIME</td>
                    ...
                    %>
                			...
                			<% } %>
        						...
        						<td align="center" nowrap>&nbsp;<%= _repDto.getBatchTime()%></td> 
                   ...
                   %>
                            <td colspan="8" align="right"><b>	Sub Total (Date : <%=txnDate%> ) : &nbsp;</b></td>
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/neftReportInput.do?module=reports&mode=input&report=NeftBrInwReturnedReport';
