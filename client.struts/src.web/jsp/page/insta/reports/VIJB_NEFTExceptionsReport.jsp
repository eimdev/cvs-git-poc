...
<nested:form action="/neftExceptionsReport">
<div id="printReady">
<%
            ...
            <tr class="row-value">
              ...
              <nested:define id = "toDate" property="reportDto.toDate" type="java.lang.String"/>
                  ...
                  <nested:define id ="tranType" property="reportDto.transactionType" type="java.lang.String"/>
                    ...
                    NEFT Exceptions Report for <%=tranType%>  Txns
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/neftReportInput.do?module=reports&mode=input&report=neftExceptionReport';
