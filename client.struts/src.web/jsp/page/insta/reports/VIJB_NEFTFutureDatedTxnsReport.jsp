...
<nested:form action="/neftFutureDatedTxnsReport">
<div id="printReady">
<%
            ...
            <tr class="row-value">
              ...
              <nested:define id = "toDate" property="reportDto.toDate" type="java.lang.String"/>
                  ...
                  <nested:define id ="status" property="reportDto.status" type="java.lang.String"/>
                    NEFT Date wise Future Dated Txns Report 
            ...
            <nested:iterate id="_reportMap" property="reportMap">
              ...
              <td  colspan="11" align="center">
                <TABLE>
                    ...
                    %>
                			...
                			<% } %>
                                ...
                                <td align="center" wrap>&nbsp;<%=_repDto.getSenderAddress()%></td>
                                 ...
                                 <td align="left" nowrap>&nbsp;<%=_repDto.getAccNo()%></td>
                                 <td align="left" wrap>&nbsp;<%=_repDto.getBeneficiaryName()%></td>
                   ...
                   <td colspan=10 align="right"><b>	Total (Date : <%=date%> )&nbsp;&nbsp;</b></td>
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/neftReportInput.do?module=reports&mode=input&report=neftFutureDatedTxns';
