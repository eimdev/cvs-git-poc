...
<nested:form action="/neftCPWiseReconcilliation">
<div id="printReady">
<%
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/neftReportInput.do?module=reports&mode=input&report=CPWiseReconcilliationReport';
