...
<nested:form action="/neftReturnPaymentRejectedReport">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr class="row-value">
        ...
        <nested:define id = "toDate" property="reportDto.toDate" type="java.lang.String"/>
            <b>
            	<font size="2.0">
                	NEFT Inward Possible Return Payment Rejected By User Report between <br><%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%>
                    and <%=InstaReportUtil.getDateInSpecificFormat(format,toDate)%>
                </font>
            </b>
    	</td>
    </tr>
	    ...
	    <td>
		 <table class="inner-table table-border" cellSpacing="1" cellPadding="2" width="100%" border="0">
          <tr class="row-label th-bc">
                ...
                <td width="10%" align="center" nowrap>Rejected By</td>
				...
				<nested:notEmpty property="reportDTOs">
				   <nested:iterate property="reportDTOs">
        			...
        			<% } %>
                        ...
                        <td align="center" nowrap><nested:write property="userId"/></td>
...
<!--
    function printScript() {
     ...
     function goBack() {
        document.forms[0].action='/insta/reports/ neftReportInput.do?module=reports&mode=input&report=neftReturnPaymentRejectedReport';
