...
<nested:form action="/returnPaymentRejectedReport">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr class="row-value">
        ...
        <nested:define id = "toDate" property="reportDto.toDate" type="java.lang.String"/>
            <b>
            	<font size="2.0">
                	RTGS Inward Possible Return Payment Rejected By User Report between <br><%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%> 
...
<!--
    ...
    function goBack() {
        document.forms[0].action='/insta/reports/reportInput.do?module=reports&mode=input&report=returnPaymentRejectedReport';
