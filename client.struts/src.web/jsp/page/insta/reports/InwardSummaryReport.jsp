...
<%@page import="com.objectfrontier.insta.reports.dto.ReportInputDTO"%>
<%@ page import ="com.objectfrontier.insta.reports.InstaReportUtil" %>
<nested:form action="/neftInwardSummaryReport">
<div id="printReady">
<%
		 ...
		 <table class="inner-table table-border" cellSpacing="1" cellPadding="2" width="100%" border="0">
            <tr class="row-value">
              <td colspan="8" align="center">
                  ...
                  <b>
                  <font size="2.5">
                    NEFT Branch wise Summary Report from <%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%> to <%=InstaReportUtil.getDateInSpecificFormat(format,toDate)%>
                ...
                <TABLE>
                    ...
                    %>
                			...
                			<% } %>
                                ...
                                <td align="center" nowrap>&nbsp;<%=_repDto.getCount()%></td>
                            <%
                   ...
                   %>
                            <td colspan="6" align="right"><b>	Total (Branchwise : <%=branch%> )&nbsp;&nbsp;</b></td>
            ...
            <tr class="row-value tr2-bc">
                <td colspan="8" align="right"><b>	Total Inward Amount : &nbsp; <%=FormatAmount.formatINRAmount(bankInwAmt)%></b></td>
            </tr>
             <tr class="row-value tr2-bc">
                <td colspan="8" align="right"><b>	Total Outward Amount : &nbsp; <%=FormatAmount.formatINRAmount(bankOutAmt)%></b></td>
            </tr>
          </nested:notEmpty>
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/reportInput.do?module=reports&mode=input&report=BranchSummaryReport';
