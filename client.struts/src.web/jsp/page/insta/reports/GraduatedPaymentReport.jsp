...
<meta http-equiv="refresh" content="60;url=/insta/reports/graduatedReport.do?mode=viewreport&module=reports" />
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td class="error" height="10"  colspan="2"><nested:write property="message"/></td>
    </tr>
</table>    
<div id="printReady">
<%
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr class="row-value">
    	<td align="center" class="row-value">
            <b>
            	<font size="2.0">
                	Graduated Payment Report on <br><nested:write property="reportDto.valueDate"/>
                </font>
            </b>
    	</td>
    </tr>
