...
<nested:form action="/brWiseReconcilliationReport">
<div id="printReady">
<%
            ...
            <tr class="row-value"> 
              <td colspan="7" align="center">
        		 ...
        		 <nested:define id = "valueDate" property="reportDto.valueDate" type="java.lang.String"/>
                  ...
                  <b>
                    <font size="2.5">Branch wise Reconciliation Report from <%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%> to <%=InstaReportUtil.getDateInSpecificFormat(format,toDate)%></font>
                  </b>
              </td>
            </tr>
              ...
              <td  colspan="7" align="center">
                <TABLE>
                    ...
                    <%
                        ...
                        int i = 0;
                    %>
						<td colspan="7" align="left"><b> Branch : <%=branch%> </b> </td>
               		</tr>
                    ...
                    <%  }
                        ...
                        <td colspan="6" align="right"><b>	Total Amount (Branch : <%=branch%> )&nbsp;&nbsp;</b></td>
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/reportInput.do?module=reports&mode=input&report=BrWiseReconcilliationReport';
