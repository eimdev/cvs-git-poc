...
<nested:form action="/brInwardBankwiseReport">
<div id="printReady">
<%
            ...
            <tr>
              <td colspan="7" align="center" class="row-value">
        		 ...
        		 <nested:define id = "valueDate" property="reportDto.valueDate" type="java.lang.String"/>
                  ...
                  <b>
                  <font size="2.5">
                    Branch Report - Inward - Bank Wise from <%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%> to <%=InstaReportUtil.getDateInSpecificFormat(format,toDate)%>
                    </font>
                  </b>
              </td>
            </tr>
...
<!--
    ...
    function goBack() {
        ...
        document.forms[0].action='/insta/reports/reportInput.do?module=reports&mode=input&report=InwardBankwiseReport';
