...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
	    <td>
         ...
         <nested:define id = "ifscCode" property="ifscCode" type="java.lang.String"/>
         <nested:define id = "userId" property="reportDto.userId" type="java.lang.String"/>
            <tr>
              <td colspan="8" align="center" class="row-value">
         		...
         		<nested:define id = "valueDate" property="reportDto.valueDate" type="java.lang.String"/>
                  ...
                  <b>
                  <font size="2.0">
                  User Level Event Alerts Report 
