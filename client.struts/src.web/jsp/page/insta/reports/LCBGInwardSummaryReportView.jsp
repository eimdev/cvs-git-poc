...
<%@page import="com.objectfrontier.insta.reports.dto.ReportInputDTO"%><nested:form action="/lcbgInwardSummaryReport">
<div id="printReady">
<%
    ...
    <tr>
	    <td>
		 <table class="inner-table table-border" cellSpacing="1" cellPadding="2" width="100%" border="0">
			  ...
			  <nested:define id="_reportTitle" property="lcbgReportTitle" type="java.lang.String" />
                <b>
                  <font size="2.5">
              ...
              <td  colspan="11" align="center">
                <TABLE>
					<tr class="row-label th-bc">
						...
						<td rowspan=2 width="5%" align="center"><nested:message key="lcbg.label.totalInward"/></td>
						<td rowspan=2 width="5%" align="center"><nested:message key="lcbg.label.inwardInprocess"/></td>
						<td rowspan=2 width="5%" align="center"><nested:message key="lcbg.label.inwardCompleted"/></td>
						<td rowspan=2 width="5%" align="center"><nested:message key="lcbg.label.totalOutward"/></td>
						<td rowspan=2 width="5%" align="center"><nested:message key="lcbg.label.outwardInprocess"/></td>
						<td rowspan=2 width="5%" align="center"><nested:message key="lcbg.label.outwardForAcknowledge"/></td>
						<td rowspan=2 width="5%" align="center"><nested:message key="lcbg.label.outwardSettled"/></td>
                    ...
                    %>
						...
						<td align="center" width="30"><%=i%></td>
                         ...
                         <td nowrap align="center">&nbsp;<%= _reportDTO.getLcbgDate() %></td>

                        <td nowrap align="center">&nbsp;<%= _reportDTO.getInwardInprocess() + _reportDTO.getInwardCompleted() %></td>

						<td nowrap align="center">&nbsp;<%= _reportDTO.getInwardInprocess() %></td>

                        <td nowrap align="center">&nbsp;<%= _reportDTO.getInwardCompleted() %></td>

						<td nowrap align="center">&nbsp;<%= _reportDTO.getOutwardInprocess() + _reportDTO.getOutwardForAcknowledge() + _reportDTO.getOutwardSettled() %></td>

                        <td nowrap align="center">&nbsp;<%= _reportDTO.getOutwardInprocess() %></td>

                        <td nowrap align="center">&nbsp;<%= _reportDTO.getOutwardForAcknowledge() %></td>

                        <td nowrap align="center">&nbsp;<%= _reportDTO.getOutwardSettled() %></td>
