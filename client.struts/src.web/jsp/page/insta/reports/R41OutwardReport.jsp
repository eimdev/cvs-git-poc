...
<nested:form action="/r41outwardreport">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr class="row-value">
    	<td align="center" class="row-value">
            <b>
            	<font size="2.0">
                	Customer Payments Submitted - Grouped By Receiver Address on <br><%=InstaReportUtil.getDateInSpecificFormat(format,valueDate)%>
                </font>
            </b>
    	</td>
    </tr>
