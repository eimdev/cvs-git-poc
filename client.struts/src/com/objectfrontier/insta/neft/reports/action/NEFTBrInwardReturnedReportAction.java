/*
 * @(#)NEFTBrInwardReturnedReportAction.java
 *
...
import com.objectfrontier.insta.rtgs.reports.action.BrInwardReturnedReportAction;
 ...
 */
public class NEFTBrInwardReturnedReportAction
extends AbstractReportAction {

        private static Category logger = Category.getInstance(BrInwardReturnedReportAction.class);

        @Override
        protected String getActionName(String mode) {

            String actionName = "insta.vijb.report.neftBrInwardReturned";
        ...
        throws Exception {
            ...
            if (mode!=null && mode.equalsIgnoreCase("viewreport")) {
                ...
                try {
                    ...
                    reportBean.generateNeftBrInwReturnedReport(request);
                ...
                try {
                    ...
                    String fileName = "BranchWise Inward Returned Report";
                    
                    if (reportBean.getReportMap().size() > 0) {
                        response.setContentType("application/vnd.ms-excel");
                        response.setHeader("Content-Disposition", "attachment;filename="+fileName+".xls");
                        reportBean.returnedInwardExportToExcel(response.getOutputStream());
                    } else {
