/*
 * @(#)NEFTExceptionsreportAction.java
 *
 ...
 */
public class NEFTExceptionsReportAction
extends AbstractReportAction {
    
private static Category logger = Category.getInstance(NEFTExceptionsReportAction.class.getName());
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("viewreport")) {
            ...
            try {
                ...
                reportBean.generateNEFTExceptionsReport(request);
            ...
            try {
                ...
                String fileName = "NEFT Exceptions Report";
                
                if (reportBean.getReportMap().size() > 0) {
                    
                    response.setContentType("application/vnd.ms-excel");
                    response.setHeader("Content-Disposition", "attachment;filename="+fileName+".xls");
                    reportBean.exceptionReportExportToExcel(response.getOutputStream(),"NEFT");      
                } else {
