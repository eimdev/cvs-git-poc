 ...
 */
public class BrOutReturnedByUserReportAction 
extends AbstractReportAction {

    private static Category logger = 
        Category.getInstance(BrOutReturnedByUserReportAction.class);

    @Override
    protected String getActionName(String mode) {

        String actionName = "insta.vijb.report.brOutReturnedByUser";
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("viewreport")) {
            ...
            try {
                ...
                //reportBean.generateBrOutReturnedByReceiverReport(request);
