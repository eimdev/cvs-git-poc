 ...
 */
public class R41InwardReportAction extends AbstractReportAction {
    ...
    protected String getActionName(String mode) {
        ...
        String actionName = "insta.rtgs.report.R41Inward";
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("input")) {
            ...
            try {
                ...
                reportBean.generateR41InwardReports(request);
            ...
            try {
                ...
                String fileName = "R41(CPN) Received ";
                
                if (reportBean.getReportDTOs().size() > 0) {
                    response.setContentType("application/vnd.ms-excel");
                    response.setHeader("Content-Disposition", "attachment;filename="+fileName+".xls");
                    reportBean.generateR41InwardExportToExcel(response.getOutputStream());
                } else {
