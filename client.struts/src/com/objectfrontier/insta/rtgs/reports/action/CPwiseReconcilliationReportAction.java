 ...
 */
public class CPwiseReconcilliationReportAction 
extends AbstractReportAction {

    private static Category logger = Category.getInstance(CPwiseReconcilliationReportAction
                                                          .class);

    @Override
    protected String getActionName(String mode) {

        String actionName = "insta.vijb.report.CPwiseReconcilliation";
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("viewreport")) {
            ...
            try {
                ...
                reportBean.generateReconcilliationReportCPwise(request);
            ...
            try {
                ...
                String fileName = "Counter Party Wise Report ";
