 ...
 */
public class R41OutwardReportAction extends AbstractReportAction {

    private static Category logger = Category.getInstance(R41OutwardReportAction.class.getName());

    @Override
    protected String getActionName(String mode) {

        String actionName = "insta.rtgs.report.R41Outward";
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("input")) {
            ...
            //Commented by priyak for date format.
            ...
            try {
                ...
                reportBean.generateR41OutwardReports(request);
            ...
            try {
                ...
                String fileName = "R41(CPR) Submitted ";
                
                if (reportBean.getReportDTOs().size() > 0) {
                    response.setContentType("application/vnd.ms-excel");
                    response.setHeader("Content-Disposition", "attachment;filename="+fileName+".xls");
                    reportBean.generateR41OutwardExportToExcel(response.getOutputStream());
                } else {
