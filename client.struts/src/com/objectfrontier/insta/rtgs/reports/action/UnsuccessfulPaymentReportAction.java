/*
 * @(#)UnsuccessfulPaymentReportAction.java
 *
 ...
 * @author mohanadevis
 * @date   Jan 11, 2010
 * @since  insta.reports; Jan 11, 2010
 */
public class UnsuccessfulPaymentReportAction 
extends AbstractReportAction {
    
    private static Category logger = Category.getInstance(UnsuccessfulPaymentReportAction.class.getName());
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("viewreport")) {
            ...
            try {
                ...
                reportBean.generateUnsuccessfulPaymentReport(request);
            ...
            try {
                ...
                String fileName = "RTGS Unsuccessful Payments Report";
                
                if (reportBean.getReportDTOs().size() > 0) {
                    
                    response.setContentType("application/vnd.ms-excel");
                    response.setHeader("Content-Disposition", "attachment;filename="+fileName+".xls");
                    reportBean.unsuccessfulPaymentReportExportToExcel(response.getOutputStream());      
                } else {
