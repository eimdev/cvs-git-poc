 ...
 */
public class BrInwardBankwiseReportAction 
extends AbstractReportAction {

    private static Category logger = Category.getInstance(BrInwardBankwiseReportAction
                                                          .class);

    @Override
    protected String getActionName(String mode) {

        String actionName = "insta.vijb.report.brInwBankWise";
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("viewreport")) {
            ...
            try {
                ...
                reportBean.generateInwardBankwiseReport(request);
            ...
            try {
                ...
                String fileName = "Inward - Bank Wise Report ";
                
                if (reportBean.getReportMap().size() > 0) {
                    reportBean.setReport("inward");
