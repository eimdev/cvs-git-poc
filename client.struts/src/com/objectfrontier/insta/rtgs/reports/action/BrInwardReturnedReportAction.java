 ...
 */
public class BrInwardReturnedReportAction 
extends AbstractReportAction {
    ...
    protected String getActionName(String mode) {
        ...
        String actionName = "insta.vijb.report.brInwardReturned";
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("viewreport")) {
            ...
            try {
                ...
                reportBean.generateBrInwReturnedReport(request);
            ...
            try {
                ...
                String fileName = "Branch Inward Returned Report ";
                
                if (reportBean.getReportMap().size() > 0) {
                    response.setContentType("application/vnd.ms-excel");
                    response.setHeader("Content-Disposition", "attachment;filename="+fileName+".xls");
                    reportBean.generateBrInwReturnedExportToExcel(response.getOutputStream());
                } else {
