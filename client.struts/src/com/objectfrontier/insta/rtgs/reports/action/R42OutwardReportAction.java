 ...
 */
public class R42OutwardReportAction extends AbstractReportAction {

    private static Category logger = Category.getInstance(R42OutwardReportAction.class.getName());

    @Override
    protected String getActionName(String mode) {

        String actionName = "insta.rtgs.report.R42Outward";
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("input")) {
            ...
            try {
                ...
                reportBean.generateR42OutwardReports(request);
            ...
            try {
                ...
                String fileName = "R42(IPR) Submitted ";
                
                if (reportBean.getReportDTOs().size() > 0) {
                    response.setContentType("application/vnd.ms-excel");
                    response.setHeader("Content-Disposition", "attachment;filename="+fileName+".xls");
                    reportBean.generateR42OutwardExportToExcel(response.getOutputStream());
                } else {
