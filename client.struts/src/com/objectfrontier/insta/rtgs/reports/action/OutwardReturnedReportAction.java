 ...
 */
public class OutwardReturnedReportAction 
extends AbstractReportAction {

    private static Category logger = Category.getInstance(OutwardReturnedReportAction.class);
    ...
    throws Exception {
        ...
        if (mode!=null && mode.equalsIgnoreCase("viewreport")) {
            ...
            try {
                ...
                reportBean.generateOwReturnedReport(request);
            ...
            try {
                ...
                if (reportBean.getReportDTOs().size() > 0) {
                    ...
                    reportBean.generateOwReturnedExportToExcel(response.getOutputStream());
                } else {
